...
function validateForm() {
	...
	var redeSocial = form["confirmarSenha"].value;
	...
	if (!redeSocial) {
		errorMessage += "O campo 'Rede Social Profissional' é obrigatório.<br>";
	}
...
function mostrarMensagem(event) {
            // Previne a interação com o campo
            event.preventDefault();
            // Exibe a mensagem personalizada
            alert("Este campo está desativado e não pode ser alterado.");
        }
