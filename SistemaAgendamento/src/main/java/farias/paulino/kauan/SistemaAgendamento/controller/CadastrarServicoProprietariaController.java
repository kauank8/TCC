...
@Controller
public class CadastrarServicoProprietariaController {
	...
	@RequestMapping(name = "cadastrarServicoProprietaria", value = "/cadastrarServicoProprietaria", method = RequestMethod.GET)
	...
	@RequestMapping(name = "cadastrarServicoProprietaria", value = "/cadastrarServicoProprietaria", method = RequestMethod.POST)
